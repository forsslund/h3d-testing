...
//
//
/// \file PhysX3BodyConstraintOptions.cpp
/// \brief Source file for PhysX3BodyConstraintOptions, X3D scene-graph node
///
//
//////////////////////////////////////////////////////////////////////////////
...
namespace PhysX3Joint6DOFLimitOptionsInternals {
  ...
  FIELDDB_ELEMENT( PhysX3Joint6DOFLimitOptions, projectionTolerance, INPUT_OUTPUT );
...
PhysX3Joint6DOFLimitOptions::PhysX3Joint6DOFLimitOptions (
  ...
  contactDistance( _contactDistance ){
    ...
    projectionTolerance->setValue( Vec2f( -1.0f, -1.0f ) );

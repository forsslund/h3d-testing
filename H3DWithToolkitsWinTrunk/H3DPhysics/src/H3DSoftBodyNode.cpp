...
previousDeformationStrategy ( NULL ) {
  ...
  /// \todo trigger a re-linking if indices of geometry change?
  /// May be required to implement cutting?
...
void H3DSoftBodyNode::LinkGeometry::update () {
  ...
  /// \todo Mapping might need to be changed in case of cutting?

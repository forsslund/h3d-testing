...
namespace H3D{
  ...
  namespace PhysicsEngineParameters {
    ...
    BulletWorldParameters () : 
      ...
      maxVelocityLinear ( 0.0f ),
      maxVelocityAngular ( 0.0f ) {}
  ...
  public:
    ...
    /// 
    /// \dotfile BulletCollidableOptions_maxVelocityLinear.dot
    ...
    /// <b>Default value:</b> 10 \n
    /// 
    /// \dotfile BulletCollidableOptions_maxVelocityAngular.dot

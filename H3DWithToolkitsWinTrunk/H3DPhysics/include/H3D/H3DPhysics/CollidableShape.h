...
namespace H3D {
  ...
  public:
    ...
    class SFShapeNode: 
      //TODO: Consider ALTERNATIVE2, which depends on the geometry::displayList instead
      ...
      &H3DDisplayListObject::displayList >, true > {
        typedef DependentSFNode< X3DShapeNode, 
          ...
          &H3DDisplayListObject::displayList >, 
          true > BaseField;
      // ALTERNATIVE2: Make the changes marked with ALTERNATIVE2 in CollidableShape.cpp
      //public DependentSFNode    < FieldRef< X3DShapeNode, X3DShapeNode::SFGeometryNode, &X3DShapeNode::geometry > > {
      //typedef DependentSFNode< FieldRef< X3DShapeNode, X3DShapeNode::SFGeometryNode, &X3DShapeNode::geometry > > BaseField;
    ...
    /// \todo implement for all physics engines.
    ///
    /// <b>Access type:</b> inputOutput \n
    /// 
    ...
    /// Set this to false if it is known that the collidable will be handled as a primitive by the underlying physics engine and not as a triangle mesh
    /// 
    /// <b>Access type: </b> inputOutput
  ...
  protected:
    ...
    // TODO: on change of geom (from shape)

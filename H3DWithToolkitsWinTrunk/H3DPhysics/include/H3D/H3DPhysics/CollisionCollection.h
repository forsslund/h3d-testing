...
namespace H3D{
  ...
  public:
    ...
    // TODO: CollidableGroup and CollidableExceptionGroup, CollidableSelectionGroup share common
    // functinality. After their roles are determined clearly, have a parent
    // class for them.

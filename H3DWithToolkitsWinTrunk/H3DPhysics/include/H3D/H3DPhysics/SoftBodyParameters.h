...
namespace H3D{
  ...
  namespace PhysicsEngineParameters {
    ...
    struct PhysicsMaterialParameters : public H3DPhysicsMaterialParameters {
      /// Constructor
    ...
    struct MassSpringPhysicsMaterialParameters : public H3DPhysicsMaterialParameters {
      /// Constructor
    ...
    struct FEMPhysicsMaterialParameters : public PhysicsMaterialParameters {
      /// Constructor

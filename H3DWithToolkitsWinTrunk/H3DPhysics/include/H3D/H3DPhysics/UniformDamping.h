...
//
//
/// \file UniformDamping.h
/// \brief Header file for UniformDamping, X3D scene-graph node
///
//
//////////////////////////////////////////////////////////////////////////////

#ifndef __UNIFORMDAMPING__
#define __UNIFORMDAMPING__
...
namespace H3D{  
  ...
  /// Node representing homogenous damping for the whole soft body.
  ///
  /// <b>Examples:</b>
  ...
  ///
  /// \par Internal routes:
  /// \dotfile UniformDamping.dot
  class H3DPHYS_API UniformDamping : public H3DPhysicsDampingNode {
  public:
  ...
  protected:
    ...
    virtual H3DFloat getDampingPerUnit(int index) { return damping->getValue(); }

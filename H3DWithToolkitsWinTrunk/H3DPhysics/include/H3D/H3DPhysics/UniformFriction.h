...
//
//
/// \file UniformFriction.h
/// \brief Header file for UniformFriction, X3D scene-graph node
///
//
//////////////////////////////////////////////////////////////////////////////

#ifndef __UNIFORMFRICTION__
#define __UNIFORMFRICTION__
...
namespace H3D{  
  ...
  /// Node representing homogenous friction for the whole soft body.
  ///
  /// <b>Examples:</b>
  ...
  ///
  /// \par Internal routes:
  /// \dotfile UniformFriction.dot
  class H3DPHYS_API UniformFriction : public H3DPhysicsFrictionNode {
  public:
  ...
  protected:
    ...
    virtual H3DFloat getFrictionPerUnit(int index) { return friction->getValue(); }

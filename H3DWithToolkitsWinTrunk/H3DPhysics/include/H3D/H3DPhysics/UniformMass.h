...
//
/// \file UniformMass.h
/// \brief Header file for UniformMass, X3D scene-graph node
///
//
//////////////////////////////////////////////////////////////////////////////

#ifndef __UNIFORMMASS__
#define __UNIFORMMASS__
...
namespace H3D{  
  ...
  /// Node representing homogenous mass for the whole soft body.
  ///
  /// <b>Examples:</b>
  ...
  ///
  /// \par Internal routes:
  /// \dotfile UniformMass.dot
  class H3DPHYS_API UniformMass : public H3DPhysicsMassNode {
  public:
  ...
  protected:
    ...
    virtual H3DFloat getMassPerUnit(int index) { return mass->getValue(); }

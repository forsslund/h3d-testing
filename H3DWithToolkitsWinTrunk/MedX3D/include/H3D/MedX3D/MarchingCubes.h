...
namespace H3D {
  ...
  public:
    ...
    protected:
      ...
      /// \param _texture_coordinate_generator_func A function to generate texture coordinates for
      /// each point.
      /// \param tex_coord_generator_data User specified data sent to function.
    ...
    /// May be removed when we have decided which mode is best.
    ///
    /// <b>Access type:</b> inputOutput

...
Internet Explorer.
To register the plugin for IE start the command promt.
...
Move the npH3D32.dll to the appropiate folder for the browser you are using.
...
Different instaces of IE also behaves correct.
...
arguments but the neccessity for this is probably very small.

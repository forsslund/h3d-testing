  ...
  //
   const string vertexshader_raycaster =
    ...
    "//BEGIN UNIFORMS\n"
     ...
     //     "uniform int volumeIndex;\n" //TODO: autogenerated uniform
     //    "uniform mat4 localToGlobalSpace[1];\n"
...
void MultiVolumeRayCaster::render( X3DVolumeNode *volume ) {
 ...
 // select and pre render shader
  ...
  // TODO: Check out GL_SAMPLE_SHADING (glEnable) and the centroid keyword, one of those
...
void MultiVolumeRayCaster::buildShader( X3DVolumeNode *in_volume ) {
  ...
  /*string stylefunction_file = 
    "C:/Users/Daniel/devel/H3D/MedX3D/src/shaders/StyleFunctions.glsl";*/
  fragmentshader += H3DVolumeRendererNode::style_function; //readShaderFromFile( stylefunction_file );

  /*string main_file = 
    "C:/Users/Daniel/devel/H3D/MedX3D/src/shaders/MultiVolumeRayCaster_FS_main.glsl"; */
 ...
 // add shader code
  ...
  // add shader compositing code TODO

...
const string H3DVolumeRendererNode::style_function =
    "//////////////////////////////////////////////////////////////////////////////\n"
    "//    Copyright 2012-2014, SenseGraphics AB\n"
    "//\n"
  ...
  "        //todo: check if we need to interpolate alpha also?\n"
  ...
  "      //current_color.a = 0.0;\n"
    ...
    "\n"
    "  vec4 return_color;  \n"
    "  // TODO: FOG parameters and multiple light sources, spot and attenuation\n"

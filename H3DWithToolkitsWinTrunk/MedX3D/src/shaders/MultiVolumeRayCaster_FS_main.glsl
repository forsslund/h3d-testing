...
// TODO: replace this with something that does not loop over all volumes.
int findClosest() {
...
void main() {
  ...
  //TODO: fix the fragdepth value. zpoint is set in code generated from X3DVolumeNode.cpp 
  // Need to figure out how to calculate tmp below using the corrent tex_to_view_mat, i.e.
  // the one used for setting zpoint

...
namespace X3DVolumeNodeInternals {
  ...
  FIELDDB_ELEMENT( X3DVolumeNode, stopRaysAtGeometries, INPUT_OUTPUT );
  FIELDDB_ELEMENT( X3DVolumeNode, renderer, INPUT_OUTPUT );
  FIELDDB_ELEMENT( X3DVolumeNode, useEmptySpaceSkipping, INPUT_OUTPUT );
  FIELDDB_ELEMENT( X3DVolumeNode, emptySpaceSkippingRes, INPUT_OUTPUT );
  FIELDDB_ELEMENT( X3DVolumeNode, showNonEmptySpace, INPUT_OUTPUT );
  FIELDDB_ELEMENT( X3DVolumeNode, useStochasticJittering, INPUT_OUTPUT );

...
void NoiseTexture::SFImage::update() {
  ...
  // TODO: need to check why seed is not used 
  ...
  int x, y;
  // TODO: when simplexNoise is false
  // perlinValue is just using uninitialized value or default value, this 
  // might contain some logic issues here

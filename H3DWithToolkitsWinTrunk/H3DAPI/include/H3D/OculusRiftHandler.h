//////////////////////////////////////////////////////////////////////////////
//    Copyright 2004-2016, SenseGraphics AB (modifications)
...
public:
  ...
  /// The returned matrix should be used as the projection matrix.
  /// \param eye_index The index of the eye (normally 0 for left and 1 for right)
  /// \returns The view-projection matrix to use for the specified eye.
  H3D::Matrix4f onEyeRender(int eye_index);
